...
class AdminDoanhThuController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($tu_ngay && $den_ngay) {
            ...
            if ($thang) {
                $top_ban_query->whereMonth('donhang.NgayDat', $thang);
            }
        }
        ...
        if ($tu_ngay && $den_ngay) {
            ...
            if ($thang) {
                $top_nhap_query->whereMonth('lichsunhaphang.NgayNhap', $thang);
            }
        }
        ...
        if ($tu_ngay && $den_ngay) {
            ...
            if ($thang) {
                $detailed_sold_products->whereMonth('donhang.NgayDat', $thang);
            }
        }
        ...
        if ($tu_ngay && $den_ngay) {
            ...
            if ($thang) {
                $order_list_query->whereMonth('NgayDat', $thang);
            }
        }
        ...
        if ($tu_ngay && $den_ngay) {
            ...
            if ($thang) {
                $revenue_by_category->whereMonth('donhang.NgayDat', $thang);
            }
        }
    ...
    private function exportToExcel($data)
    {
        ...
        if ($tu_ngay && $den_ngay) {
            ...
            if ($thang) {
                $revenueByCategory->whereMonth('donhang.NgayDat', $thang);
            }
        }
